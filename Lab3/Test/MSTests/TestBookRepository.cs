...
namespace Test.MSTests
{
    ...
    public class TestBookRepository
    {
        ...
        public static void ClassInitialize(TestContext context)
        {
            ...
            books.AddBook(new Book(1, "1", "Description", 10, 2008, Book.Generes.action));
            ...
            books.AddBook(new Book(9, "9", "Description", 90, 2016, Book.Generes.story));
            books.AddBook(new Book(10, "10", "Description", 100, 2017, Book.Generes.story));
        }
